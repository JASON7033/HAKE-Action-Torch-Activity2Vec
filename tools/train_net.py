...
if __name__ == "__main__":
    ...
    print("----"*5+"test"+str(torch.cuda.is_available()))
    # build network
    net   = pasta_res50(cfg)

    optimizer = optim.SGD(filter(lambda p: p.requires_grad, net.parameters()), lr=cfg.TRAIN.BASE_LR, momentum=0.9) # 一种优化方法quaternion
