...
#-----PANDA
__C.DATA.ANNO_DB_PANDA_PATH=osp.join(__C.DATA.DATA_DIR,'panda/image_annos')
__C.DATA.PANDA_IMAGE_FOLDER_LIST = osp.join(__C.DATA.DATA_DIR, 'metadata', 'data_path_panda.json')
#-----HAKE
