...
reader = TurboJPEG(r"/usr/local/lib/libturbojpeg.so")
# reader=TurboJPEG()
...
class hake_train(torch.utils.data.Dataset):
    def __init__(self, cfg):
        ...
        self.cfg = cfg
        #-----panda
        self.db=lmdb.open(self.cfg.DATA.ANNO_DB_PANDA_PATH)
        self.image_folder_list = json.load(open(self.cfg.DATA.PANDA_IMAGE_FOLDER_LIST, 'r'))
